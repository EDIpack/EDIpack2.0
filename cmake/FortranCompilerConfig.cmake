...
if(CMAKE_Fortran_COMPILER_ID MATCHES GNU) # this is gfortran
  ...
  ENDIF()
  SET(CMAKE_Fortran_FLAGS_RELEASE "-O2   -funroll-loops -fno-fast-math")     
  SET(CMAKE_Fortran_FLAGS_TESTING "-O1 -fimplicit-none -Wsurprising  -Waliasing -fbacktrace -ffree-line-length-none")
...
elseif(CMAKE_Fortran_COMPILER_ID MATCHES PGI)
  ...
  SET(CMAKE_Fortran_FLAGS_AGGRESSIVE   "-g -O0 -Mframe")
endif()
