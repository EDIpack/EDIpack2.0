MODULE ED_AUX_FUNX
  !
  !:synopsis: Assortment of auxiliary procedures required throughout the code
...
contains
  ...
  subroutine search_chemical_potential(var,ntmp,converged)
    ...
    !
    !**NOTE:** this function is accessible to the user as :f:func:`edipack/ed_search_chemical_potential`
