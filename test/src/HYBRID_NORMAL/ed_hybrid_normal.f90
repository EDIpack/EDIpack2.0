...
contains
  ...
  subroutine set_twobody_hk()
    ...
    call ed_add_twobody_operator(1,"d",2,"u",1,"d",2,"u",2.000000d0)
    call ed_add_twobody_operator(1,"u",2,"d",1,"u",2,"d",2.000000d0)
    call ed_add_twobody_operator(2,"d",1,"u",2,"d",1,"u",2.000000d0)
    call ed_add_twobody_operator(2,"u",1,"d",2,"u",1,"d",2.000000d0)
    call ed_add_twobody_operator(1,"u",2,"u",1,"u",2,"u",2.000000d0)
    call ed_add_twobody_operator(1,"d",2,"d",1,"d",2,"d",2.000000d0)
    call ed_add_twobody_operator(2,"u",1,"u",2,"u",1,"u",2.000000d0)
    call ed_add_twobody_operator(2,"d",1,"d",2,"d",1,"d",2.000000d0)
    call ed_add_twobody_operator(1,"u",2,"u",2,"u",1,"u",0.125000d0)
    call ed_add_twobody_operator(1,"d",2,"d",2,"d",1,"d",0.125000d0)
    call ed_add_twobody_operator(2,"u",1,"u",1,"u",2,"u",0.125000d0)
    call ed_add_twobody_operator(2,"d",1,"d",1,"d",2,"d",0.125000d0)
    call ed_add_twobody_operator(1,"d",2,"u",2,"d",1,"u",0.125000d0)
    call ed_add_twobody_operator(1,"u",2,"d",2,"u",1,"d",0.125000d0)
    call ed_add_twobody_operator(2,"d",1,"u",1,"d",2,"u",0.125000d0)
    call ed_add_twobody_operator(2,"u",1,"d",1,"u",2,"d",0.125000d0)
    call ed_add_twobody_operator(1,"d",1,"u",2,"d",2,"u",0.125000d0)
    call ed_add_twobody_operator(1,"u",1,"d",2,"u",2,"d",0.125000d0)
    call ed_add_twobody_operator(2,"d",2,"u",1,"d",1,"u",0.125000d0)
    call ed_add_twobody_operator(2,"u",2,"d",1,"u",1,"d",0.125000d0)
